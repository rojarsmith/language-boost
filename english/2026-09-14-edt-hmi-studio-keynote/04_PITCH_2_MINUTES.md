...
>
> The AI assistant can also create a project, turn a visual reference into screens, or make a focused edit. The result remains normal project content that the team can inspect, edit, and undo.
