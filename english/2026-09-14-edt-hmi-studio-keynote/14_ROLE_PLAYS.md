...
> We have a US$200 million annual run-rate scenario, not an approved forecast. It assumes US$160 million from production display programs, US$20 million from paid services, and US$20 million from strategic agreements. Every line needs customer and financial validation.
...
> The public Alpha is for controlled key-stakeholder evaluation, so I am asking for a bounded pilot, not a broad rollout. The pilot should prove whether Studio makes demos, qualification, and design-in conversion more repeatable before either side makes a larger investment.
