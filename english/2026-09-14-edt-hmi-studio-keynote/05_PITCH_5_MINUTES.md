...
>
> The AI assistant can create a project, turn a visual reference into screens, or make a focused edit through the editor. The result remains normal project content, so the team can inspect it, refine it by hand, and undo the applied AI change as one step.
>
