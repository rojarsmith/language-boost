...
> The public 0.8.5 Alpha is available for evaluation by key stakeholders. It is evaluation software, with explicit limitations and no downstream-customer distribution under the current public terms.

內部 source 版本比公開下載版新。公開狀態一律以官方頁面與核准文字為準。

### 12. When will it launch? `[CONFIRM]`

目前安全版：

> The official page currently shows a December 2026 general-release roadmap. That is a roadmap, not an unconditional promise. I will confirm the approved release schedule before making a commitment.

### 13. Which operating systems will you support? `[QUALIFY]`

> The public Alpha page lists Windows 10 and 11, 64-bit. The source contains work for other desktop platforms, but the final production support matrix for macOS and Linux still requires approval.
...
> The current scenario has three possible engines: production display programs, paid AI and enterprise services, and strategic agreements. The exact offers, prices, channel economics, and accounting treatment still require company approval.
